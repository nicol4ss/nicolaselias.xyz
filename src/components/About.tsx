...
function About({ translate, setTranslate }: AboutProps) {
  ...
  de Ciências da Computação na Universidade Federal de Santa Catarina em Florianópolis - SC. Tenho experiência de mais de dois ano
